...
class PN_CalendarCell {
    ...
    public function draw($events) {
        ...
        <span id="<?php echo $this->cell_year.'-'.$this->cell_month.'-'.$day;?>" data-year="<?php echo $this->cell_year ?>" data-month="<?php echo $this->cell_month ?>" data-day="<?php echo $this->cell_day ?>" data-week-day-num="<?php echo $this->get_week_day_num() ?>" class="<?php if ($this->in_current_month): ?>pn_this_month<?php else: ?>other_month1<?php endif; ?>" ><?php echo $this->cell_day; ?></span>
